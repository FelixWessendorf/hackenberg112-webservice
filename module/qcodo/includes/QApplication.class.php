<?php
	...
	abstract class QApplication extends QApplicationBase {
		 ...
		 * @throws Exception
		 */
        public static function GenerateOrmCode($strPassword){
			if($strPassword!==QCODO_PASSWORD) throw new Exception("Permission denied.");
            exec(__DIR__."/../cli/qcodo codegen",$aryOutput);
            return implode("\n",$aryOutput);
        }
