<?php
	...
	class PersonListPanel extends QPanel {
		...
		public function __construct($objParentObject, $strSetEditPanelMethod, $strCloseEditPanelMethod, $strControlId = null) {
			...
			$this->dtgPeople->MetaAddColumn('PersonId');
			$this->dtgPeople->MetaAddColumn('Sex');
			...
			$this->dtgPeople->MetaAddColumn('DateOfEntry');
			$this->dtgPeople->MetaAddColumn(QQN::Person()->Rank);
			$this->dtgPeople->MetaAddColumn('Active');
