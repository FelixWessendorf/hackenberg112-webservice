<?php
	 ...
	 * 
	 */
	class OperationListPanel extends QPanel {
		// Local instance of the Meta DataGrid to list Operations
		public $dtgOperations;
		...
		public function __construct($objParentObject, $strSetEditPanelMethod, $strCloseEditPanelMethod, $strControlId = null) {
			...
			// Setup the Template
			$this->Template = 'OperationListPanel.tpl.php';
			...
			$this->dtgOperations->ItemsPerPage = 8;
			...
			$this->dtgOperations->MetaAddEditProxyColumn($this->pxyEdit, 'Edit', 'Edit');
		...
		public function pxyEdit_Click($strFormId, $strControlId, $strParameter) {
			...
			$objEditPanel = new OperationEditPanel($this, $this->strCloseEditPanelMethod, $strParameterArray[0]);
