<?php
	...
	class PersonEditPanel extends QPanel {
		...
		public function __construct($objParentObject, $strClosePanelMethod, $intPersonId = null, $strControlId = null) {
			// Call the Parent
			try {
			...
			$this->mctPerson = PersonMetaControl::Create($this, $intPersonId);

			// Call MetaControl's methods to create qcontrols based on Person's data fields
			$this->lblPersonId = $this->mctPerson->lblPersonId_Create();
			$this->txtSex = $this->mctPerson->txtSex_Create();
			...
			$this->calDateOfEntry = $this->mctPerson->calDateOfEntry_Create();
			$this->lstRank = $this->mctPerson->lstRank_Create();
			$this->chkActive = $this->mctPerson->chkActive_Create();
